package org.SirTobiSwobi.c3.ntfc;
...
import org.SirTobiSwobi.c3.ntfc.api.TCSvmModel;
import org.SirTobiSwobi.c3.ntfc.api.TCSvmNode;
import org.SirTobiSwobi.c3.ntfc.api.TCWordEmbedding;
import org.SirTobiSwobi.c3.ntfc.core.Classifier;
import org.SirTobiSwobi.c3.ntfc.core.Trainer;
import org.SirTobiSwobi.c3.ntfc.core.Utilities;
import org.SirTobiSwobi.c3.ntfc.db.CategorizationManager;
import org.SirTobiSwobi.c3.ntfc.db.Category;
import org.SirTobiSwobi.c3.ntfc.db.CategoryManager;
import org.SirTobiSwobi.c3.ntfc.db.Configuration;
import org.SirTobiSwobi.c3.ntfc.db.ConfigurationManager;
import org.SirTobiSwobi.c3.ntfc.db.Document;
import org.SirTobiSwobi.c3.ntfc.db.DocumentManager;
import org.SirTobiSwobi.c3.ntfc.db.EvaluationManager;
import org.SirTobiSwobi.c3.ntfc.db.MlrType;
import org.SirTobiSwobi.c3.ntfc.db.Model;
import org.SirTobiSwobi.c3.ntfc.db.ModelManager;
import org.SirTobiSwobi.c3.ntfc.db.ReferenceHub;
import org.SirTobiSwobi.c3.ntfc.db.RelationshipType;
import org.SirTobiSwobi.c3.ntfc.db.SelectionPolicy;
import org.SirTobiSwobi.c3.ntfc.db.TargetFunctionManager;
import org.SirTobiSwobi.c3.ntfc.db.WordEmbedding;
import org.SirTobiSwobi.c3.ntfc.db.WordEmbeddingManager;
import org.SirTobiSwobi.c3.ntfc.db.WordEmbeddingMetadata;
import org.SirTobiSwobi.c3.ntfc.health.ConfigHealthCheck;
import org.SirTobiSwobi.c3.ntfc.resources.ActiveModelResource;
import org.SirTobiSwobi.c3.ntfc.resources.AssignmentResource;
import org.SirTobiSwobi.c3.ntfc.resources.CategoriesResource;
import org.SirTobiSwobi.c3.ntfc.resources.CategorizationsResource;
import org.SirTobiSwobi.c3.ntfc.resources.CategoryResource;
import org.SirTobiSwobi.c3.ntfc.resources.ConfigurationResource;
import org.SirTobiSwobi.c3.ntfc.resources.ConfigurationsResource;
import org.SirTobiSwobi.c3.ntfc.resources.DocumentResource;
import org.SirTobiSwobi.c3.ntfc.resources.DocumentsResource;
import org.SirTobiSwobi.c3.ntfc.resources.EvaluationsResource;
import org.SirTobiSwobi.c3.ntfc.resources.MetadataResource;
import org.SirTobiSwobi.c3.ntfc.resources.ModelResource;
import org.SirTobiSwobi.c3.ntfc.resources.ModelsResource;
import org.SirTobiSwobi.c3.ntfc.resources.RelationshipResource;
import org.SirTobiSwobi.c3.ntfc.resources.RelationshipsResource;
import org.SirTobiSwobi.c3.ntfc.resources.RetrainingResource;
import org.SirTobiSwobi.c3.ntfc.resources.TargetFunctionResource;
import org.SirTobiSwobi.c3.ntfc.resources.TrainingSessionResource;
import org.SirTobiSwobi.c3.ntfc.resources.WordEmbeddingResource;
import org.SirTobiSwobi.c3.ntfc.resources.WordEmbeddingsResource;
import org.glassfish.jersey.media.multipart.MultiPartFeature;

public class NtfcApplication extends Application<NtfcConfiguration> {

	public static void main(String[] args) throws Exception {
		new NtfcApplication().run(args);
	}
	...
	@Override
	public void initialize(Bootstrap<NtfcConfiguration> bootstrap){
	
		bootstrap.addBundle(new AssetsBundle("/assets/", "/html/", "index.html"));
	}

	@Override
	public void run(NtfcConfiguration configuration, Environment environment){
		/*
